...
namespace EventHub.Controllers
{
    public class CommentController : Controller
    {
        ...
        public ActionResult GroupCreate(FormCollection collection)
        {
            try
            {
                // TODO: Add insert logic here
                int thisId = Int32.Parse(collection.Get("GroupId"));
                var groups = db.Groups.Single(a => a.Id == thisId);
                ...
                return RedirectToAction("Details", "Group", new { id = groups.Id });
            }
            catch
            {
                return View();
